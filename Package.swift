...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g6aa1953f1a/BNBPoseEstimation.zip",
            checksum: "ef963246c9dcc319823311b880195f58fdb3e4510c8ad5a6af8c6de4773808af"
        ),
        .target(
