...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-63-g5825a46ccf/BNBPoseEstimation.zip",
            checksum: "edc0a486e8276e611238f65cb2c7119a5b788fdc9f6ba918249efef915167700"
        ),
        .target(
