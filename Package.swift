...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-61-g2b7f7b2a6c/BNBPoseEstimation.zip",
            checksum: "366b3bbc8c82995bee7dd4172906344a91f6f9bc5b7c379e1af78a5e44706e07"
        ),
        .target(
