...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-62-g077d3df291/BNBPoseEstimation.zip",
            checksum: "bac7356e1872c09aec71205074409412b1665389268bc4c6ce8fa557d31ce06e"
        ),
        .target(
