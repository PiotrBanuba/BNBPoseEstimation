...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "BNBPoseEstimation",
            url: "https://d2cm7wtcqqw29.cloudfront.net/1.8.0-64-g951557ebd1/BNBPoseEstimation.zip",
            checksum: "3beb97d0321099f0bcde587a5e0e666e0a68f22460dbaa3b3cc2bf75821cce10"
        ),
        .target(
